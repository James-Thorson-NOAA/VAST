...
template<class Type>
matrix<Type> create_loadings_general( vector<Type> L_val, int n_rows, int n_f ){
  if( n_f == -2 ){
    // IID
    matrix<Type> L_rc(n_rows, n_rows);
    L_rc.setZero();
...
matrix<Type> gmrf_by_category_nll( int n_f, int method, int timing, int n_s, int n_c, Type logkappa, array<Type> gmrf_input_sf, array<Type> gmrf_mean_sf, vector<Type> L_z, density::GMRF_t<Type> gmrf_Q, int simulate_random_effects, Type &jnll_pointer, objective_function<Type>* of){
  ...
  matrix<Type> L_cf = create_loadings_general( L_z, n_c, n_f );
...
// Output: jnll_comp(0), Omega1_sc
//template<class Type>                                                                                        //
// array<Type> project_factors_to_years( int n_f1, int method, int n_s, int n_f2, array<Type> epsiloninput_sff, vector<Type> L_z ){
//}
