...
# Augment objects in TmbData (to deal with backwards compatibility)
  ...
  if(Version %in% c("VAST_v6_0_0","VAST_v5_5_0","VAST_v5_4_0","VAST_v5_3_0","VAST_v5_2_0","VAST_v5_1_0","VAST_v5_0_0","VAST_v4_4_0","VAST_v4_3_0","VAST_v4_2_0","VAST_v4_1_0") & Options['normalize_GMRF_in_CPP']==FALSE ){
