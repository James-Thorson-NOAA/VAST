...
# Version
Version_VAST = SpatialDeltaGLMM::get_latest_version( package="VAST" )
...
# Use local path
#singlespecies_example_path <- "C:/Users/James.Thorson/Desktop/Project_git/geostatistical_delta-GLMM/inst/extdata/"
